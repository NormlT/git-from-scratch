...
5. Walk me through each exercise step by step:
   ...
   - After I run it, explain what happened
   - For key concepts, ask me to predict the outcome before running
6. After all exercises are complete, run the verification steps from the lab
7. If verification passes, update `progress.md` by checking off the completed module
8. Suggest the bonus challenge if one exists, but don't require it
